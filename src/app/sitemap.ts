...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    { url: "https://anuragair.com", lastModified: new Date(), changeFrequency: "weekly", priority: 1 },
    { url: "https://anuragair.com/tracker", lastModified: new Date(), changeFrequency: "daily", priority: 0.9 },
