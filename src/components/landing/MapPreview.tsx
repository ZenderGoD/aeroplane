...
const aircraftPositions = [
  { x: 15, y: 25, size: 2.5, color: "var(--text-secondary)" },
  { x: 35, y: 18, size: 2, color: "var(--text-secondary)" },
  { x: 52, y: 42, size: 3, color: "var(--text-secondary)" },
  { x: 78, y: 30, size: 2, color: "var(--text-secondary)" },
  { x: 22, y: 55, size: 2.5, color: "var(--text-tertiary)" },
  { x: 65, y: 60, size: 2, color: "var(--text-secondary)" },
  { x: 88, y: 48, size: 2.5, color: "var(--text-secondary)" },
  { x: 42, y: 72, size: 2, color: "var(--text-secondary)" },
  { x: 70, y: 78, size: 3, color: "var(--accent-primary)" },
  { x: 25, y: 80, size: 2, color: "var(--text-secondary)" },
  { x: 55, y: 20, size: 2, color: "var(--text-secondary)" },
  { x: 82, y: 65, size: 2.5, color: "var(--text-secondary)" },
  { x: 10, y: 40, size: 2, color: "var(--text-secondary)" },
  { x: 48, y: 50, size: 2, color: "var(--text-secondary)" },
  { x: 92, y: 22, size: 2, color: "var(--text-secondary)" },
  { x: 30, y: 35, size: 2.5, color: "var(--text-secondary)" },
  { x: 60, y: 85, size: 2, color: "var(--text-secondary)" },
  { x: 75, y: 15, size: 2, color: "var(--text-tertiary)" },
  { x: 40, y: 90, size: 2.5, color: "var(--text-secondary)" },
  { x: 58, y: 35, size: 2, color: "var(--text-secondary)" },
];
