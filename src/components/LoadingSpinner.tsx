      ...
      <div className="text-center animate-fade-in">
        ...
        <div className="relative w-20 h-20 mx-auto mb-4">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-2 h-2 rounded-full bg-cyan-400 shadow-[0_0_12px_rgba(34,211,238,0.5)]" />
          </div>
          {/* Blip dots */}
          <div className="absolute top-3 right-5 w-1 h-1 rounded-full bg-cyan-400/60 animate-pulse" />
          <div className="absolute bottom-5 left-4 w-1 h-1 rounded-full bg-cyan-400/40 animate-pulse [animation-delay:0.5s]" />
        </div>
        ...
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <span className="text-lg font-bold tracking-wider bg-gradient-to-r from-cyan-300 to-blue-400 bg-clip-text text-transparent">
            AeroIntel
          </span>
        </div>
